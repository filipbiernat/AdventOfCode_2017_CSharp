namespace AdventOfCode2017.Day16
{
    public class Day16B : IDay
    {
        ...
        public void Run()
        {
            ...
            List<char> initialOrderOfThePrograms = new(Programs);
            ...
            while (!Enumerable.SequenceEqual(initialOrderOfThePrograms, Programs));
            ...
            for (int danceIndex = 0; danceIndex < 1000000000 % cycleLength; ++danceIndex)
            {
                danceMoves.ForEach(MakeADanceMove);
            }
